...
// %v akan digantikan dengan nilai dari observed dan expected.
// Jadi, jika observed adalah "Hello, World!" dan expected juga "Hello, World!", maka format string akan digantikan dengan nilai-nilai tersebut, dan hasil akhirnya adalah pesan yang menunjukkan bahwa nilai yang diobservasi sesuai dengan yang diharapkan.
